...
public class BinaryGap {
    public int solution(int N) {
        ...
        int maxGap = 0;
        while (matcher.find()) {
            // Obter o comprimento do gap atual
            int gapLength = matcher.group().length();
            // Atualizar o maior gap encontrado
    ...
    public static void main(String[] args) {
        ...
        int [] range = {1,2,147,483,647};
        for (int j : range) {
            System.out.println(test.solution(j));
        }
    }
}
